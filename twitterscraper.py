...
def get_all_tweets(screen_name):
	...
	outtweets = [[tweetlink + tweet.id_str, tweet.created_at + timedelta(hours=-4), tweet.text.encode("utf-8")] for tweet in alltweets]
	

	#write the csv	
	with open('csvs/kaitlyn.csv'.format(screen_name), 'w') as f:
		writer = csv.writer(f)
...
if __name__ == '__main__':
	...
	get_all_tweets("@KaitlynLandgraf")